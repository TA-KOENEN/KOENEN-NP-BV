                    ...
                    <div v-if="question_e === 'ke1'">
                      ...
                      <div v-if="question_i === 'ke1'">
                        ...
                        <div v-if="question_m === 'ke1'">
                          ...
                          />
                          <StatementText
                            :text="textData[8].textAppForm"
                            :note="textData[8].commentApp"
                            :nr-notes="textData[8].nrNotes"
                            :noteA="textData[8].noteAppFormA"
                            :noteB="textData[8].noteAppFormB"
                            :noteC="textData[8].noteAppFormC"
                            class="mb-5"
                          />
                          <StatementText
                          ...
                          <base-val-area
                            rules="max:500"
                            v-model="text_d"
                            v-bind:label="statement[20].label"
                          />
                          <StatementText
                          ...
                          <base-radio
                            ...
                            :error-messages="errors"
                            rules="required"
                            v-bind:nrOptions="statement[21].nrOptions"
                            v-bind:optionA="statement[21].optionA"
                            v-bind:optionB="statement[21].optionB"
                            v-bind:optionC="statement[21].optionC"
                            v-bind:optionD="statement[21].optionD"
                          />
                          <div v-if="question_q === 'ke1'">
                            <StatementText
                              :text="textData[9].textAppForm"
                              :note="textData[9].commentApp"
                              :nr-notes="textData[9].nrNotes"
                              :noteA="textData[9].noteAppFormA"
                              :noteB="textData[9].noteAppFormB"
                              :noteC="textData[9].noteAppFormC"
                              class="mb-5"
                            />
                            <StatementText
                            ...
                            />
                            <StatementText
                              :text="textData[10].textAppForm"
                              :note="textData[10].commentApp"
                              :nr-notes="textData[10].nrNotes"
                              :noteA="textData[10].noteAppFormA"
                              :noteB="textData[10].noteAppFormB"
                              :noteC="textData[10].noteAppFormC"
                              class="mb-5"
                            />
                            <StatementText
                            ...
                            />
                            <StatementText
                              :text="textData[11].textAppForm"
                              :note="textData[11].commentApp"
                              :nr-notes="textData[11].nrNotes"
                              :noteA="textData[11].noteAppFormA"
                              :noteB="textData[11].noteAppFormB"
                              :noteC="textData[11].noteAppFormC"
                              class="mb-5"
                            />
                          </div>
                        </div>
                    ...
                    <div v-if="question_e === 'ke1'">
                      ...
                      <div v-if="question_i === 'ke1'">
                        ...
                        <div v-if="question_m === 'ke1'">
                          ...
                          />
                          <StatementText
                            :text="textData[8].textAppInform"
                            :note="textData[8].commentApp"
                            :nr-notes="textData[8].nrNotes"
                            :noteA="textData[8].noteAppInfA"
                            :noteB="textData[8].noteAppInfB"
                            :noteC="textData[8].noteAppInfC"
                            class="mb-5"
                          />
                          <StatementText
                          ...
                          <div v-if="question_q === 'ke1'">
                            <StatementText
                              :text="textData[9].textAppInform"
                              :note="textData[9].commentApp"
                              :nr-notes="textData[9].nrNotes"
                              :noteA="textData[9].noteAppInfA"
                              :noteB="textData[9].noteAppInfB"
                              :noteC="textData[9].noteAppInfC"
                              class="mb-5"
                            />
                            <StatementText
                            ...
                            />
                            <StatementText
                              :text="textData[10].textAppInform"
                              :note="textData[10].commentApp"
                              :nr-notes="textData[10].nrNotes"
                              :noteA="textData[10].noteAppInfA"
                              :noteB="textData[10].noteAppInfB"
                              :noteC="textData[10].noteAppInfC"
                              class="mb-5"
                            />
                            <StatementText
                            ...
                            />
                            <StatementText
                              :text="textData[11].textAppInform"
                              :note="textData[11].commentApp"
                              :nr-notes="textData[11].nrNotes"
                              :noteA="textData[11].noteAppInfA"
                              :noteB="textData[11].noteAppInfB"
                              :noteC="textData[11].noteAppInfC"
                              class="mb-5"
                            />
                          </div>
                        </div>
...
<script>
import textAppLeft from "@/text/moduleL/textAppLeftL.json";
import textAppRight from "@/text/moduleL/textAppRightL.json";
import Questions from "@/text/moduleL/moduleL.json";
import ExtraText from "@/text/moduleL/textL.json";
...
export default {
  ...
  data() {
    return {
      ...
      text_d: "",
      text_e: "",
      finishModLpartA: true,
      finishModLpartB: false,
      finishModLpartC: false,
      finishModLpartD: false,
      finishModL: false,
      saving: false,
    };
  },
  methods: {
    ...
    saveItem() {
      this.finishModLpartA = true;
      this.finishModL = true;
      this.saving = true;
      ...
      const payload = {
        ...
        text_d: this.text_d,
        text_e: this.text_e,
        finishModLpartA: this.finishModLpartA,
        finishModLpartB: this.finishModLpartB,
        finishModLpartC: this.finishModLpartC,
        finishModLpartD: this.finishModLpartD,
        finishModL: this.finishModL,
      };
      resultService
        .saveDataL(clientId, payload)
        .then(() => {
        ...
        .then(() => {
          this.saving = false;
          this.$router.push({ name: "module-l-end" });
        });
    },
  },
  computed: {
  ...
  mounted() {
    ...
    this.question_a = this.planSingle.l_bv.question_a;
    this.question_b = this.planSingle.l_bv.question_b;
    this.question_c = this.planSingle.l_bv.question_c;
    this.question_d = this.planSingle.l_bv.question_d;
    this.question_e = this.planSingle.l_bv.question_e;
    this.question_f = this.planSingle.l_bv.question_f;
    this.question_g = this.planSingle.l_bv.question_g;
    this.question_h = this.planSingle.l_bv.question_h;
    this.question_i = this.planSingle.l_bv.question_i;
    this.question_j = this.planSingle.l_bv.question_j;
    this.question_k = this.planSingle.l_bv.question_k;
    this.question_l = this.planSingle.l_bv.question_l;
    this.question_m = this.planSingle.l_bv.question_m;
    this.question_n = this.planSingle.l_bv.question_n;
    this.question_o = this.planSingle.l_bv.question_o;
    this.question_p = this.planSingle.l_bv.question_p;
    this.question_q = this.planSingle.l_bv.question_q;
    this.question_r = this.planSingle.l_bv.question_r;
    this.question_s = this.planSingle.l_bv.question_s;
    this.question_t = this.planSingle.l_bv.question_t;
    this.text_a = this.planSingle.l_bv.text_a;
    this.text_b = this.planSingle.l_bv.text_b;
    this.text_c = this.planSingle.l_bv.text_c;
    this.text_d = this.planSingle.l_bv.text_d;
    this.text_e = this.planSingle.l_bv.text_e;
    this.finishModL = this.planSingle.finishModL;
    this.finishModLpartA = this.planSingle.finishModLpartA;
    this.finishModLpartB = this.planSingle.finishModLpartB;
    this.finishModLpartC = this.planSingle.finishModLpartC;
    this.finishModLpartD = this.planSingle.finishModLpartD;
  },
};
</script>
