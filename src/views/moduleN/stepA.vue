...
import Questions from "@/text/moduleN/moduleN.json";
import ExtraText from "@/text/moduleN/textN.json";
...
export default {
  ...
  data() {
    return {
      ...
      text_c: "",
      text_d: "",
      finishModNpartA: true,
      finishModNpartB: false,
      finishModNpartC: false,
      finishModNpartD: false,
      finishModN: false,
      saving: false,
    };
  },
  methods: {
    ...
    saveItem() {
      this.finishModNpartA = true;
      this.finishModN = true;
      this.saving = true;
      ...
      const payload = {
        ...
        text_c: this.text_c,
        text_d: this.text_d,
        finishModNpartA: this.finishModNpartA,
        finishModNpartB: this.finishModNpartB,
        finishModNpartC: this.finishModNpartC,
        finishModNpartD: this.finishModNpartD,
        finishModN: this.finishModN,
      };
      resultService
        .saveDataN(clientId, payload)
        .then(() => {
        ...
        .then(() => {
          this.saving = false;
          this.$router.push({ name: "module-n-end" });
        });
    },
  },
  computed: {
  ...
  mounted() {
    ...
    this.question_a = this.planSingle.n_bv.question_a;
    this.question_b = this.planSingle.n_bv.question_b;
    this.question_c = this.planSingle.n_bv.question_c;
    this.question_d = this.planSingle.n_bv.question_d;
    this.question_e = this.planSingle.n_bv.question_e;
    this.question_f = this.planSingle.n_bv.question_f;
    this.question_g = this.planSingle.n_bv.question_g;
    this.question_h = this.planSingle.n_bv.question_h;
    this.question_i = this.planSingle.n_bv.question_i;
    this.question_j = this.planSingle.n_bv.question_j;
    this.question_k = this.planSingle.n_bv.question_k;
    this.question_l = this.planSingle.n_bv.question_l;
    this.question_m = this.planSingle.n_bv.question_m;
    this.question_n = this.planSingle.n_bv.question_n;
    this.question_o = this.planSingle.n_bv.question_o;
    this.question_p = this.planSingle.n_bv.question_p;
    this.question_q = this.planSingle.n_bv.question_q;
    this.question_r = this.planSingle.n_bv.question_r;
    this.question_s = this.planSingle.n_bv.question_s;
    this.question_t = this.planSingle.n_bv.question_t;
    this.text_a = this.planSingle.n_bv.text_a;
    this.text_b = this.planSingle.n_bv.text_b;
    this.text_c = this.planSingle.n_bv.text_c;
    this.text_d = this.planSingle.n_bv.text_d;
    this.finishModN = this.planSingle.finishModN;
    this.finishModNpartA = this.planSingle.finishModNpartA;
    this.finishModNpartB = this.planSingle.finishModNpartB;
    this.finishModNpartC = this.planSingle.finishModNpartC;
    this.finishModNpartD = this.planSingle.finishModNpartD;
  },
};
</script>
