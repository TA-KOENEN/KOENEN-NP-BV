...
import textAppLeft from "@/text/moduleM/textAppLeftM.json";
import textAppRight from "@/text/moduleM/textAppRightM.json";
...
export default {
  ...
  methods: {
    nextStep() {
      ...
      this.$router.push({ name: "module-m-step-a" });
    },
    stopThis() {
